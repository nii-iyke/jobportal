...
<a href="http://www.fluids.design/Jobportal"><img alt="" src="/Jobportal/images/logo.png " style="text-align:centre;margin-left:35%;" width="260" height="56"></a>   
    <div class="jumbotron">
       <h1 style = "color :#696969 "><span style="color:#ee7e2c;">Register</span> your company</h1>
        <div id="insidejumb">
...
<form role="form" id="regcomp" onsubmit="return checkForm()" class="form-horizontal" method="post" action="process_regemp.php" style="font-family:Open sans">
...
<div class="page-header"></div>
<h3 class="h3style"; style = "color : green"> Your Company Details</h3>
<div class="page-header"></div>
...
<div class="form-group">
        <label class="control-label col-sm-2"> Where are you currently located? </label>
                  <div class="col-sm-4">
                    <input type="text" id="cityId" placeholder="Location" name="city" class="form-control" 
                    required> 
                </div>
</div>
    <div class="form-group">
        ...
        <div class="col-sm-5">
            <textarea placeholder="Describe your company" class="form-control" id="abtcomp" name="compdetails" rows="5" required onblur="validate('longtext','abouterror',this.value)"></textarea>
            <label class="error" id="abouterror"></label>
        </div>
    </div>
    <div class="page-header"> </div>
   <div class="form-group form-inline col-sm-10">
   <label for="reg" class="control-label col-sm-5"></label>
