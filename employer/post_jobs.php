...
if(desig == '' && vacancy == '' && desc == '' && profile=='' && pay=='') {
   return true;
    ...
    <div id="nav">
        ...
        <!--    <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">   
                    <input type="text" id="cityId" class="form-control" name="city" class="form-control" 
                    required> 
            </div> 
            </div>
            <div class="form-group">
            ...
            <div class="page-header" />
                <div class="form-group">
                    <label for="ugcourse" class="control-label col-sm-2">Specify Qualification:</label>
               ...
               <option value="Other">Other</option>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5"><textarea id="profile" rows="5" name="profile" class="form-control" required onblur="validate('longtext','profile',this.value)"></textarea></div>
                    <label class="error" id="profile"></label>
                </div>
                <div class="page-header" />
                <p> Are you sure to submit the job! Check for errors before submitting the job</p>
                <div class="form-group col-sm-2">
                     <button class="btn btn-lg btn-success btn-block" type="submit" id="postbtn">Post Job</button>
        </form>
           </div>
    </body>
