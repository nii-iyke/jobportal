...
<ul class="nav nav-tabs">
    <li class="active"><a data-toggle="tab" href="#details" style = "color : green">Your Profile</a></li>
    <li><a data-toggle="tab"  href="#recjobs" style = "color : green">Recommended Jobs</a></li>
    <li><a data-toggle="tab" href="#resume" style = "color : green">Update Resume</a></li>
    <li><a data-toggle="tab" href="#advsearch" style = "color : green">Advanced Search</a></li>
</ul>
    ...
    <div class="tab-content">
        ...
        <tr>
           <td class="tbold">Certificate Attained:</td>
            <td><?php echo $row['basic_edu']; ?></td>
        </tr>
        <tr>
            <td class="tbold">Educational level:</td>
    ...
    <div id="recjobs" class="tab-pane fade" style="margin-top: 20px;">
        ...
        if(mysqli_num_rows($q)>0) {
            echo "<h3>These jobs are recommended to you based on your profile:</h3>";
  ...
  */
           ...
           echo "<h3 style='color: #122b40; margin-top: 30px;'>No jobs are recommended to you at this moment! </h3>";
        }
        ?>
        </table>
    </div>
...
<!--- Resume  -->
    ...
    echo "<div class='alert alert-danger alert-dismissible' role='alert'>
           ...
           <p style='font-size: 20px'><strong>Note:</strong> You haven't uploaded a resume file yet! Upload an attractive resume file for a better job!</p>
        </div>";
}?>
