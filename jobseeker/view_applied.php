...
<body>
<div class="container">
    <h3 class="text-center" style="margin-top: 50px; color: green">You Applied for these jobs</h3>
 ...
 <!-- <table class="table table-responsive" style="margin-top: 30px;">
    ...
    <?php } else {  echo " <div class='container'> <div class='alert alert-warning alert-dismissible' role='alert'>
           ...
           <p style='font-size: 20px'><strong>Note:</strong> You have not applied for any jobs yet!</p>
        </div> </div>";
        }
     ?>
</div>
